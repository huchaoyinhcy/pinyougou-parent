...
app.controller('goodsController', function ($scope, $controller, $location, goodsService, itemCatService, typeTemplateService, uploadService) {
    ...
    //读取二级分类
    $scope.$watch('entity.goods.category1Id', function (newValue, oldVaule) {
    ...
    //读取三级分类
    $scope.$watch('entity.goods.category2Id', function (newValue, oldVaule) {
        itemCatService.findByParentId(newValue).success(
            function (response) {
    ...
    //读取模板id
    $scope.$watch('entity.goods.category3Id', function (newValue, oldVaule) {
